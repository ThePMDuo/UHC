...
namespace AGTHARN\uhc\libs\poggit\libasynql;

use InvalidArgumentCountException;
use pocketmine\plugin\Plugin;
use pocketmine\utils\Terminal;
use pocketmine\utils\Utils;
use AGTHARN\uhc\libs\poggit\libasynql\base\DataConnectorImpl;
use AGTHARN\uhc\libs\poggit\libasynql\base\SqlThreadPool;
use AGTHARN\uhc\libs\poggit\libasynql\mysqli\MysqlCredentials;
use AGTHARN\uhc\libs\poggit\libasynql\mysqli\MysqliThread;
use AGTHARN\uhc\libs\poggit\libasynql\sqlite3\Sqlite3Thread;
...
final class libasynql{
	...
	public static function detectPackaged() : void{
		...
		if(!self::$packaged && defined("pocketmine\\VERSION")){ /** @phpstan-ignore-line */
